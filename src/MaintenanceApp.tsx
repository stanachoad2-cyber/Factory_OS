...
export default function MaintenanceSettingsContent({
  ...
  // fetchAutoParts was accidentally placed here; removed to fix TS error.
        ...
        <div className="flex items-center gap-3">
          ...
          <div className="flex flex-col">
            ...
            <span className="text-[10px] text-slate-400 mt-1">
              {activeTab === 1 && "แจ้งซ่อม / รายการงานเปิด"}
              {activeTab === 2 && "รายการกำลังซ่อมแซม"}
              {activeTab === 3 && "ตรวจสอบความเรียบร้อย"}
              {!activeTab && "ระบบซ่อมบำรุง"}
            </span>
          </div>
        </div>
      </div>
